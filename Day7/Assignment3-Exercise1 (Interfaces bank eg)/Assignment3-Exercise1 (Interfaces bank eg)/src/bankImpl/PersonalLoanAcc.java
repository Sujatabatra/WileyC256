...
public class PersonalLoanAcc implements LoanAcc, DebitInterest {
	...
	public PersonalLoanAcc(long loanAccNo, String accHolderName, double principalAmount) {
	...
	public double calcInt() {
		return principalAmount*personalLoanInterest/100;
	...
	public void displayAccInfo() {
		System.out.println(personalLoan+" account");
